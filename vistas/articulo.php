                        ...
                        <div class="box">
                            ...
                            <div class="panel-body" id="formularioregistros">
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label for="stock">Sub Categoria(*):</label>
                                        <input type="number" class="form-control" name="subcategoria" id="subcategoria">
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="precioVta" id="precioVta"
                                               maxlength="256" placeholder="Precio">
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label>Folio:</label>
                                        <input type="text" class="form-control" name="folio" id="folio"
                                               maxlength="256" placeholder="Folio">
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label>Lote:</label>
                                        <input type="text" class="form-control" name="lote" id="lote"
                                               maxlength="256" placeholder="Lote">
                                    </div>
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label>Caducidad:</label>
                                        <input type="text" class="form-control" name="caducidad" id="caducidad"
                                               maxlength="256" placeholder="Caducidad">
                                    </div>
                                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <label>Costo:</label>
                                            <input type="text" class="form-control" name="costo" id="costo"
                                                   maxlength="256" placeholder="Costo">
                                        </div>
                                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <label>Descuento:</label>
                                                <input type="text" class="form-control" name="descuento" id="descuento"
                                                       maxlength="256" placeholder="Descuento">
                                            </div>
                                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label>Proveedor:</label>
                                                    <input type="text" class="form-control" name="idProveedor" id="idProveedor"
                                                           maxlength="256" placeholder="Proveedor">
                                                </div>
                                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <label>Numero de Artículo:</label>
                                                        <input type="text" class="form-control" name="numeroArticulo" id="numeroArticulo"
                                                               maxlength="256" placeholder="# Artículo">
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
